...
public class DbClass {
    ...
    public boolean addPatient(String name, String guardian, String regNo, String gender, String role, String depart, String handicap, String address, Long mobile, String email, String blood, String cnic, String natio, String track, String psy, String join, String land, String med, String sem, String dur, String days, String fees, String shift, String civil, String post, String salary, String work, String dob){
        try {
            st = Connect().createStatement();
            String sql="INSERT INTO patientDetails(pName, GuardianName, RegistrationNo, Gender, Role, Department, Handicap, Address, Mobile, Email, BloodGroup, trackRecord, isPsyFit, JoiningDate, Landline, hasMedIns, Semester, SemDuration, Days, SemFees, Shift, isCivil, Post, Salary, work, Dob)"
                    + "VALUES('"+ name +"','" + guardian + "','" + regNo + "','" + gender + "','" + role + "','" + depart + "','" + handicap + "','" + address + "','" + mobile + "','" + email + "','" + blood + "','" + track + "','" + psy + "','" + join + "','" + land + "','" + med + "','" + sem + "','" + dur + "','" + days + "','" + fees + "','" + shift + "','" + civil + "','" + post + "','" + salary + "','" + work + "','" + dob + "')";
            int result = st.executeUpdate(sql);
            if(result > 1){
                flag = true;
            }
