...
public class AddPWo extends javax.swing.JFrame {
   ...
   AddPWo() {
    ...
    // Creating Instance
    private static AddPWo instance = null;
    public static AddPWo getInstance() {
        if(instance == null)
            instance = new AddPWo();
        return instance;
    }
...
if (txtName.getText().equals("") || 
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(AddPWo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            new AddPWo().setVisible(true);
        });
    }
