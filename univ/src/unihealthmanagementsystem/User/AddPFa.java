...
public class AddPFa extends javax.swing.JFrame {
   ...
   AddPFa() {
    ...
    // Creating Instance
    private static AddPFa instance = null;
    public static AddPFa getInstance() {
        if(instance == null)
            instance = new AddPFa();
        return instance;
    }
    ...
    private void initComponents() {
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(jLabel45, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(15, 15, 15)))
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jScrollPane1.setBounds(0, 60, 950, 370);
            ...
            try {
                ...
                if (!isEmailValid(txtEmail.getText())) {
                    ...
                    boolean val = dbClass.addPatient(
                        ...
                        txtDepart.getText(), 
                        txtAddress.getText(), 
                        Long.valueOf(txtMobile.getText()), 
                        txtEmail.getText(), 
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(AddPFa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            new AddPFa().setVisible(true);
        });
    }
